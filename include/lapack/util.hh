...
typedef lapack_logical (*lapack_s_select2) ( float* omega_real, float* omega_imag );
typedef lapack_logical (*lapack_s_select3) ( float* alpha_real, float* alpha_imag, float* beta );

typedef lapack_logical (*lapack_d_select2) ( double* omega_real, double* omega_imag );
typedef lapack_logical (*lapack_d_select3) ( double* alpha_real, double* alpha_imag, double* beta );

typedef lapack_logical (*lapack_c_select1) ( std::complex<float>* omega );
typedef lapack_logical (*lapack_c_select2) ( std::complex<float>* alpha, std::complex<float>* beta );

typedef lapack_logical (*lapack_z_select1) ( std::complex<double>* omega );
typedef lapack_logical (*lapack_z_select2) ( std::complex<double>* alpha, std::complex<double>* beta );
